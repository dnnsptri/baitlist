...
import { createTailwindMerge, getDefaultConfig } from '../packages/subframe-core/external/tailwind-merge/dist/bundle-mjs.mjs';
...
function createTwClassNames(subframeFontMixins) {
    var customTWMerge = createTailwindMerge(function () {
        ...
        return __assign(__assign({}, defaultConfig), { classGroups: __assign(__assign({}, defaultConfig.classGroups), { 
                ...
                "subframe-font-mixins": subframeFontMixins }), conflictingClassGroups: __assign(__assign({}, defaultConfig.conflictingClassGroups), { 
                // font colors
                // "text-color": ["subframe-colors"],
                // font mixins
                "subframe-font-mixins": ["font-size", "leading", "font-weight"], "font-size": ["subframe-font-mixins"], leading: ["subframe-font-mixins"], "font-weight": ["subframe-font-mixins"] }) });
    });
    return function () {
        var args = [];
