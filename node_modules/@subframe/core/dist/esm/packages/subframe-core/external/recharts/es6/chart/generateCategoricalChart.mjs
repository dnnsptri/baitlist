...
import isNil from '../../../../../../external/lodash/isNil.mjs';
import isFunction from '../../../../../../external/lodash/isFunction.mjs';
import range from '../../../../../../external/lodash/range.mjs';
import get from '../../../../../../external/lodash/get.mjs';
import sortBy from '../../../../../../external/lodash/sortBy.mjs';
import throttle from '../../../../../../external/lodash/throttle.mjs';
import { clsx } from '../../../clsx/dist/clsx.mjs';
import invariant from '../../../../../../external/tiny-invariant/dist/esm/tiny-invariant.mjs';
import { Surface } from '../container/Surface.mjs';
import { Layer } from '../container/Layer.mjs';
import { Tooltip } from '../component/Tooltip.mjs';
import { Legend } from '../component/Legend.mjs';
import { Dot } from '../shape/Dot.mjs';
import { isInRectangle } from '../shape/Rectangle.mjs';
import { isChildrenEqual, findChildByType, validateWidthHeight, findAllByType, getDisplayName, filterProps, renderByOrder, parseChildIndex, getReactEventByType } from '../util/ReactUtils.mjs';
import { Brush } from '../cartesian/Brush.mjs';
import { getOffset } from '../util/DOMUtils.mjs';
import { getAnyElementOfObject, findEntryInArray, isNumber, uniqueId, hasDuplicate } from '../util/DataUtils.mjs';
import { calculateActiveTickIndex, getStackGroupsByAxisId, getTooltipItem, getTicksOfAxis, getBandSizeOfAxis, appendOffsetOfLegend, getStackedDataOfItem, getBarSizeList, getBarPosition, combineEventHandlers, getMainColorOfGraphicItem, parseSpecifiedDomain, getDomainOfDataByKey, parseDomainOfCategoryAxis, parseErrorBarsOfAxis, getDomainOfStackGroups, getDomainOfItemsWithSameAxis, isCategoricalAxis } from '../util/ChartUtils.mjs';
import { detectReferenceElementsDomain } from '../util/DetectReferenceElementsDomain.mjs';
import { inRangeOfSector, polarToCartesian } from '../util/PolarUtils.mjs';
import { shallowEqual } from '../util/ShallowEqual.mjs';
import { eventCenter, SYNC_EVENT } from '../util/Events.mjs';
import { adaptEventHandlers } from '../util/types.mjs';
import { AccessibilityManager } from './AccessibilityManager.mjs';
import { isDomainSpecifiedByUser } from '../util/isDomainSpecifiedByUser.mjs';
import { isFunnel, isPie, isScatter, getActiveShapeIndexForTooltip } from '../util/ActiveShapeUtils.mjs';
import { Cursor } from '../component/Cursor.mjs';
import { ChartLayoutContextProvider } from '../context/chartLayoutContext.mjs';
import { getLegendProps } from '../util/getLegendProps.mjs';
