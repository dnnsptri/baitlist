"use client";
import { __rest, __assign } from '../_virtual/_tslib.mjs';
import classNames from 'classnames';
import * as React from 'react';
import AutoSizer from '../packages/subframe-core/external/react-virtualized-auto-sizer/dist/react-virtualized-auto-sizer.esm.mjs';
import styles from './charts.module.css.mjs';
import { XAxis as XAxis$1 } from '../packages/subframe-core/external/recharts/es6/cartesian/XAxis.mjs';
import { YAxis as YAxis$1 } from '../packages/subframe-core/external/recharts/es6/cartesian/YAxis.mjs';
import { Tooltip } from '../packages/subframe-core/external/recharts/es6/component/Tooltip.mjs';
import { Legend } from '../packages/subframe-core/external/recharts/es6/component/Legend.mjs';
import { Label } from '../packages/subframe-core/external/recharts/es6/component/Label.mjs';
import { CartesianGrid as CartesianGrid$1 } from '../packages/subframe-core/external/recharts/es6/cartesian/CartesianGrid.mjs';
...
var XAxis = function (props) {
    return React.createElement(XAxis$1, __assign({}, props));
};
...
var YAxis = function (props) {
    return React.createElement(YAxis$1, __assign({}, props));
};
