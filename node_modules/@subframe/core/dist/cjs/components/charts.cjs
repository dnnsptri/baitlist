...
var reactVirtualizedAutoSizer_esm = require('../packages/subframe-core/external/react-virtualized-auto-sizer/dist/react-virtualized-auto-sizer.esm.cjs');
var charts_module = require('./charts.module.css.cjs');
var XAxis$1 = require('../packages/subframe-core/external/recharts/es6/cartesian/XAxis.cjs');
var YAxis$1 = require('../packages/subframe-core/external/recharts/es6/cartesian/YAxis.cjs');
var Tooltip = require('../packages/subframe-core/external/recharts/es6/component/Tooltip.cjs');
var Legend = require('../packages/subframe-core/external/recharts/es6/component/Legend.cjs');
var Label = require('../packages/subframe-core/external/recharts/es6/component/Label.cjs');
var CartesianGrid$1 = require('../packages/subframe-core/external/recharts/es6/cartesian/CartesianGrid.cjs');
...
var AutoSizedChartWrapper = React__namespace.forwardRef(function AutoSizedChartWrapper(_a, ref) {
    ...
    return (React__namespace.createElement("div", _tslib.__assign({ className: classNames(className, charts_module.default.root), ref: ref }, props, { style: _tslib.__assign(_tslib.__assign({}, style), { minHeight: 200, minWidth: 300 }) }),
        React__namespace.createElement(reactVirtualizedAutoSizer_esm.default, null, function (_a) {
...
var CartesianGrid = function (_a) {
    ...
    return (React__namespace.createElement(CartesianGrid$1.CartesianGrid, _tslib.__assign({ className: classNames(className, charts_module.default.grid, (_b = {}, _b[charts_module.default.dark] = dark, _b)), horizontal: horizontal, vertical: vertical, strokeWidth: strokeWidth, ref: ref }, otherProps)));
};
...
function DefaultTooltip(_a) {
    ...
    if (active && payload && payload.length) {
        return (React__namespace.createElement("div", { className: classNames(charts_module.default.tooltip, (_b = {}, _b[charts_module.default.dark] = dark, _b)) },
            label ? React__namespace.createElement("div", null, label) : null,
            payload.map(function (_a, index) {
                var name = _a.name, value = _a.value;
                return (React__namespace.createElement("div", { className: charts_module.default.row, key: index },
                    React__namespace.createElement("span", { className: charts_module.default.dot, style: { backgroundColor: colorMap.get(String(name)) } }),
                    React__namespace.createElement("span", { className: charts_module.default.name }, name !== null && name !== void 0 ? name : ""),
                    React__namespace.createElement("span", { className: charts_module.default.value }, value)));
            })));
    }
    return null;
}
...
function DefaultLegend(_a) {
    ...
    return (React__namespace.createElement("div", { className: classNames(charts_module.default.legend, (_b = {},
            _b[charts_module.default.dark] = dark,
            _b[charts_module.default.left] = align === "left",
            _b[charts_module.default.center] = align === "center",
            _b[charts_module.default.right] = align === "right",
            _b)) }, payload.map(function (_a, index) {
        var value = _a.value;
        return (React__namespace.createElement("div", { className: charts_module.default.row, key: index },
            React__namespace.createElement("span", { className: charts_module.default.dot, style: { backgroundColor: colorMap.get(String(value)) } }),
            React__namespace.createElement("span", { className: charts_module.default.name }, value)));
    })));
}
