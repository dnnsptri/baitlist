...
var millisecond = require('./millisecond.cjs');
var second = require('./second.cjs');
var minute = require('./minute.cjs');
var hour = require('./hour.cjs');
var day = require('./day.cjs');
var week = require('./week.cjs');
var month = require('./month.cjs');
var year = require('./year.cjs');
var bisector = require('../../d3-array/src/bisector.cjs');
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function tickInterval(start, stop, count) {
    ...
    const i = bisector.default(([,, step]) => step).right(tickIntervals, target);
