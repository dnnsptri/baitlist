...
var sequential = require('./sequential.cjs');
var symlog = require('./symlog.cjs');
var pow = require('./pow.cjs');
var piecewise = require('../../d3-interpolate/src/piecewise.cjs');
var value = require('../../d3-interpolate/src/value.cjs');
var round = require('../../d3-interpolate/src/round.cjs');
...
function transformer() {
  ...
  function range(interpolate) {
    return function(_) {
      var r0, r1, r2;
      return arguments.length ? ([r0, r1, r2] = _, interpolator = piecewise.default(interpolate, [r0, r1, r2]), scale) : [interpolator(0), interpolator(0.5), interpolator(1)];
    };
  }

  scale.range = range(value.default);

  scale.rangeRound = range(round.default);
