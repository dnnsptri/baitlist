...
var isNumber$1 = require('../../../../../../external/lodash/isNumber.cjs');
...
var isNumber = function isNumber(value) {
  return isNumber$1.default(value) && !isNaN.default(value);
};
var isNumOrStr = function isNumOrStr(value) {
  return isNumber(value) || isString.default(value);
};
var idCounter = 0;
...
var getPercentValue = function getPercentValue(percent, totalValue) {
  ...
  if (!isNumber(percent) && !isString.default(percent)) {
    return defaultValue;
  }
  var value;
