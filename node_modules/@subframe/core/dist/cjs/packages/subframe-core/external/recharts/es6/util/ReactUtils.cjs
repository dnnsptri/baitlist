...
var index = require('../../../../../../external/react-is/index.cjs');
var DataUtils = require('./DataUtils.cjs');
var ShallowEqual = require('./ShallowEqual.cjs');
...
var isSvgElement = function isSvgElement(child) {
  return child && child.type && isString.default(child.type) && SVG_TAGS.indexOf(child.type) >= 0;
};
