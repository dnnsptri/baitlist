...
var d3Scale = require('../../../../../../external/victory-vendor/es/d3-scale.cjs');
var max = require('../../../../../../external/lodash/max.cjs');
var min = require('../../../../../../external/lodash/min.cjs');
var isNil = require('../../../../../../external/lodash/isNil.cjs');
var isFunction = require('../../../../../../external/lodash/isFunction.cjs');
var isString = require('../../../../../../external/lodash/isString.cjs');
var get = require('../../../../../../external/lodash/get.cjs');
var flatMap = require('../../../../../../external/lodash/flatMap.cjs');
var isNaN = require('../../../../../../external/lodash/isNaN.cjs');
var upperFirst = require('../../../../../../external/lodash/upperFirst.cjs');
var isEqual = require('../../../../../../external/lodash/isEqual.cjs');
var sortBy = require('../../../../../../external/lodash/sortBy.cjs');
var getNiceTickValues = require('../../../../../../external/recharts-scale/es6/getNiceTickValues.cjs');
var ErrorBar = require('../cartesian/ErrorBar.cjs');
var DataUtils = require('./DataUtils.cjs');
var ReactUtils = require('./ReactUtils.cjs');
var getLegendProps = require('./getLegendProps.cjs');
var band = require('../../../../../../external/d3-scale/src/band.cjs');
var linear = require('../../../../../../external/d3-scale/src/linear.cjs');
var stack = require('../../../../../../external/d3-shape/src/stack.cjs');
var none = require('../../../../../../external/d3-shape/src/order/none.cjs');
var expand = require('../../../../../../external/d3-shape/src/offset/expand.cjs');
var none$1 = require('../../../../../../external/d3-shape/src/offset/none.cjs');
var silhouette = require('../../../../../../external/d3-shape/src/offset/silhouette.cjs');
var wiggle = require('../../../../../../external/d3-shape/src/offset/wiggle.cjs');
...
function getValueByDataKey(obj, dataKey, defaultValue) {
  if (isNil.default(obj) || isNil.default(dataKey)) {
    return defaultValue;
  }
...
function getDomainOfDataByKey(data, key, type, filterNil) {
  ...
  if (type === 'number') {
    ...
    return domain.length ? [min.default(domain), max.default(domain)] : [Infinity, -Infinity];
  }
  var validateData = filterNil ? flattenData.filter(function (entry) {
    return !isNil.default(entry);
  }) : flattenData;
  ...
  for (var i = 0, len = numericAxisIds.length; i < len; i++) {
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        ...
        var barSize = isNil.default(selfSize) ? globalSize : selfSize;
        result[cateId].push({
          item: barItems[0],
          stackList: barItems.slice(1),
          barSize: isNil.default(barSize) ? undefined : DataUtils.getPercentValue(barSize, totalSize, 0)
        });
      }
    }
  }
...
var getDomainOfErrorBars = function getDomainOfErrorBars(data, item, dataKey, layout, axisType) {
  ...
  if (errorBars && errorBars.length) {
    ...
    return data.reduce(function (result, entry) {
      ...
      if (isNil.default(entryValue)) return result;
      var mainValue = Array.isArray(entryValue) ? [min.default(entryValue), max.default(entryValue)] : [entryValue, entryValue];
...
var getTicksOfAxis = function getTicksOfAxis(axis, isGrid, isAll) {
  ...
  if (isGrid && (axis.ticks || axis.niceTicks)) {
    ...
    return result.filter(function (row) {
      return !isNaN.default(row.coordinate);
    });
  }
...
var parseScale = function parseScale(axis, chartType, hasBar) {
  ...
  if (isString.default(scale)) {
    var name = "scale".concat(upperFirst.default(scale));
    return {
...
var offsetSign = function offsetSign(series) {
  ...
  for (var j = 0, m = series[0].length; j < m; ++j) {
    ...
    var negative = 0;
    for (var i = 0; i < n; ++i) {
      var value = isNaN.default(series[i][j][1]) ? series[i][j][0] : series[i][j][1];
...
var getTicksOfScale = function getTicksOfScale(scale, opts) {
  ...
  if (tickCount && type === 'number' && originalDomain && (originalDomain[0] === 'auto' || originalDomain[1] === 'auto')) {
    ...
    scale.domain([min.default(tickValues), max.default(tickValues)]);
    return {
...
function getCateCoordinateOfLine(_ref5) {
  ...
  if (axis.type === 'category') {
    ...
    if (!axis.allowDuplicatedCategory && axis.dataKey && !isNil.default(entry[axis.dataKey])) {
      // @ts-expect-error why does this use direct object access instead of getValueByDataKey?
  ...
  var value = getValueByDataKey(entry, !isNil.default(dataKey) ? dataKey : axis.dataKey);
  return !isNil.default(value) ? axis.scale(value) : null;
}
var getCateCoordinateOfBar = function getCateCoordinateOfBar(_ref6) {
  ...
  return !isNil.default(value) ? axis.scale(value) - bandSize / 2 + offset : null;
};
...
var getDomainOfSingle = function getDomainOfSingle(data) {
  return data.reduce(function (result, entry) {
    return [min.default(entry.concat([result[0]]).filter(DataUtils.isNumber)), max.default(entry.concat([result[1]]).filter(DataUtils.isNumber))];
  }, [Infinity, -Infinity]);
};
...
var getBandSizeOfAxis = function getBandSizeOfAxis(axis, ticks, isBar) {
  ...
  if (axis && ticks && ticks.length >= 2) {
    var orderedTicks = sortBy.default(ticks, function (o) {
      return o.coordinate;
    });
...
var parseDomainOfCategoryAxis = function parseDomainOfCategoryAxis(specifiedDomain, calculatedDomain, axisChild) {
  ...
  if (isEqual.default(specifiedDomain, get.default(axisChild, 'type.defaultProps.domain'))) {
    return calculatedDomain;
  }
